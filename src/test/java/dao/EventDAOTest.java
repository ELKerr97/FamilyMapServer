...
public class EventDAOTest {
  ...
  public void retrievalPass() throws DataAccessException {
    ...
    assertEquals(testEvent, bestEvent);
  }

  @Test
  public void retrievalFail() throws DataAccessException {
    eDao.insert(bestEvent);
    Event testEvent = eDao.find("fakeID123");
    assertNull(testEvent);
  }

  @Test
  public void clearPass() throws DataAccessException {
    Event otherEvent = new Event("event123", "user123", "person123",
            507F, 12.13F, "USA", "Boise", "Marriage", 1908);
    eDao.insert(bestEvent);
